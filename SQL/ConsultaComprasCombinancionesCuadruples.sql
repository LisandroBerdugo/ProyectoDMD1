...
-- Contamos cuántas veces cuatro productos aparecen juntos en la misma compra
SELECT P1.Producto AS Producto1, 
       P2.Producto AS Producto2, 
       P3.Producto AS Producto3, 
       P4.Producto AS Producto4, 
       COUNT(*) AS Frecuencia
...
JOIN ProductosComprados P4 ON P1.Nombre = P4.Nombre AND P3.Producto < P4.Producto
GROUP BY P1.Producto, P2.Producto, P3.Producto, P4.Producto
